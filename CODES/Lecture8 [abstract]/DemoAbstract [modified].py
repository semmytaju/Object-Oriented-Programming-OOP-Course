...
obj_corco = Amfibi('Buaya', '5 Tahun', 'Amfibi', 'Putih', 'Male') # object 3

# class Mamalia
obj_cat.get_name("Kucing Hitam")
obj_cat.get_age("50 Tahun")

# class Bird
obj_bird.get_name("Burung Gereja")
obj_bird.get_age("30 Tahun")

# class Salmon
obj_salmon.get_name("Lumba-lumba")
obj_salmon.get_age("10 Tahun")

# class Amfibi
obj_corco.get_name("Buaya Putih")
obj_corco.get_age("110 Tahun")
